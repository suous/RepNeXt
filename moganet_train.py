...
Started from MogaNet. Many thanks to the authors.
github: https://github.com/Westlake-AI/MogaNet
arxiv:  https://arxiv.org/abs/2211.03295
...
def validate(model, loader, loss_fn, args, amp_autocast=suppress, log_suffix=''):
    ...
    with torch.no_grad():
        for batch_idx, (input, target) in enumerate(loader):
            ...
            if utils.is_main_process() and (last_batch or batch_idx % args.log_interval == 0):
